...
class RetailGenerator:
    ...
    def generate(self) -> Dataset:
        ...
        data["stores"] = [
            {"store_id": i, "store_name": f"Errdain Store {i:03d}", "city": CITIES[(i - 1) % len(CITIES)][0], "state": CITIES[(i - 1) % len(CITIES)][1], "country": "USA", "open_date": str(self.today - timedelta(days=365 * ((i % 15) + 1)))}
