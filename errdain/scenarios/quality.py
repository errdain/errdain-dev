...
from errdain.scenarios.configuration import scenario_configuration_metadata
...
def build_scenario_quality_summary(audit: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "audit_files": {
            "scenario_quality_audit": "errdain/scenarios/catalog/scenario_quality_audit.yaml",
            "scenario_quality_summary": "errdain/scenarios/catalog/scenario_quality_summary.yaml",
        },
        "v1_quality_gate": {
