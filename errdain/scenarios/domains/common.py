...
from errdain.canonical import PRIMARY_TABLES
from errdain.scenarios.models import FailureSpecification, ScenarioDefinition, ScenarioReference, ScenarioVariation
...
def scenario(
    *,
    ...
    return ScenarioDefinition(
        ...
        prerequisite_entities=["valid clean baseline", "domain relationships generated by Errdain"],
        ...
        limitations=["Scenario uses shared Errdain issue primitives; highly specialized custom row mutation may be added later if beta users need it."],
    )
